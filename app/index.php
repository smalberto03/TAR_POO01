    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST['btn']))
            {
                ...
                {
                    $str0 = trim($_POST['input_consulta']); //Quitas los espacios en blanco que haya antes despues y entre de una cadena de caracteres 

                    $str = substr($str0, 0, 6); //Extrae caracteres de una cadena de caracteres (La cadena que se quere extraer, indice desde donde empieza a extraer, numero de caracteres que extrae) 
                    //echo($str.'<br>');
